...
class LabelFile(object):
    ...
    def savePascalVocFormat(self, filename, shapes, imagePath, imageData,
                            lineColor=None, fillColor=None, databaseSrc=None, enable_hierarchy=False):
        ...
        writer = PascalVocWriter(imgFolderPath, imgFileName, imageShape, enable_hierarchy=enable_hierarchy)
        ...
        for shape in shapes:
            ...
            writer.addBndBox(bndbox[0], bndbox[1], bndbox[2], bndbox[3],
                             label, difficult, bbox_source, id_number, score, mask, parents=parents, children=children)

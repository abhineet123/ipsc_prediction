...
img_norm_cfg = dict(
    mean=[110.655, 110.655, 110.655], std=[23.259, 23.259, 23.259], to_rgb=True)
train_pipeline = [
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file=data_root + 'ipsc_2_class_g4_train.json',
        img_prefix=data_root,
        pipeline=train_pipeline),
    val=dict(
        type=dataset_type,
        ann_file=data_root + 'ipsc_2_class_g4_val.json',
        img_prefix=data_root,

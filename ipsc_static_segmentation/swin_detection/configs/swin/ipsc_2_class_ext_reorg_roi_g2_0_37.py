_base_ = [
    '../_base_/models/cascade_mask_rcnn_swin_fpn_ipsc_2_class.py',
...
img_norm_cfg = dict(
    mean=[130.260, 130.260, 130.260],
    std=[16.855, 16.855, 16.855],
    to_rgb=True)
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file=data_root + 'ext_reorg_roi_g2_0_37-train.json',
        img_prefix=data_root,
        pipeline=train_pipeline),
    val=dict(
        samples_per_gpu=1,
        type=dataset_type,
        ann_file=data_root + 'ext_reorg_roi_g2_0_37-val.json',
        img_prefix=data_root,
        pipeline=test_pipeline),
    g2_39_53=dict(
        samples_per_gpu=1,
        type=dataset_type,
        ann_file=data_root + 'ext_reorg_roi_g2_38_53.json',
        img_prefix=data_root,
        pipeline=test_pipeline),
    g2_seq_1_39_53=dict(
        samples_per_gpu=1,
        type=dataset_type,
        ann_file=data_root + 'ext_reorg_roi_g2_seq_1_38_53.json',
        img_prefix=data_root,
        pipeline=test_pipeline),
)
